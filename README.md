...
- TinyCNN MNIST 起步已量測（2026-05-27, macOS arm64）：Keras accuracy `0.9765` / size `0.5654 MiB` / p50 `2.70 ms/cell`；TFLite int8 accuracy `0.9770` / size `0.0517 MiB` / p50 `0.033 ms/cell`。Accuracy 距 `>= 98%` 門檻短 ~0.3%，size 與 latency 均達標。詳見 [docs/TINY_CNN_MODEL_RESULT_SPEC.md](docs/TINY_CNN_MODEL_RESULT_SPEC.md)。
